...
This section describes best practices related to Gaelic Algorithmic Research Group reports and publications.  
...
We have created an [Gaelic Algorithmic Research Group repository](https://zenodo.org/communities/Gaelic Algorithmic Research Group-ucsb/) for all of our reports to live. To upload to the Gaelic Algorithmic Research Group community repository, use [this link](https://zenodo.org/deposit/new?c=Gaelic Algorithmic Research Group-ucsb) and fill out all of the required information.
...
Generally, Gaelic Algorithmic Research Group researchers should be prepared to share a public GitHub repository (see Section 6.4) and a Dryad data repository with publications. The repositories contain code scripts and data (respectively) needed to conduct the study. Increasingly, journals are requiring both sets of documentation at the point of submission or publication. 

Dryad is an open-access repository of research data that makes data searchable, freely accessible, and citable. Data repositories do not need to be associated with a publication. Dryad is [free for Eddie affiliates](https://www.library.ucsb.edu/research-data-services/repository) with a Eddie NetID. The following steps document the process for creating a Dryad repository. Review Dryad’s [Best Practices website](https://datadryad.org/stash/best_practices#organize) for more useful information.
...
As with data, we strive to make all our code available. This provides a roadmap of converting input data into tangible results, which may be of interest for external people seeking to replicate our study or for internal Gaelic Algorithmic Research Groupers seeking to understand what someone did a few years ago.
...
Any time Gaelic Algorithmic Research Group develops publicly available datasets, Shiny apps, or tools, we would love to share these on the Gaelic Algorithmic Research Group website. Any time you release a publicly available dataset, Shiny app, or other tool, please let us know. Will's email address (w.lamb@ed.ac.uk)
